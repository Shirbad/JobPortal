    ...
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        ...
        >
          ...
          {/* User Menu (Profile, Saved Jobs, Applied Jobs) */}
          {role !== "admin" && (
            <ul className="py-2 text-gray-700">
              <li>
                <Link to="/CandidateProfile" className="block px-4 py-3 hover:bg-gray-100">
                  Profile
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/Review" className="block px-4 py-3 hover:bg-gray-100">
                  Review
                </Link>
              </li>
              <li>
                <Link to="/UserSetting" className="block px-4 py-3 hover:bg-gray-100">
                  Settings
                </Link>
              </li>
            </ul>
